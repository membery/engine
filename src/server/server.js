...
mongoDriver.init(config.mongoDbURI, function(err) {
	...
	var templateListPaths = JSON.parse(
	...
	app.get('/portal/templates/getAll', securityService.hasPermFilter('System User').check, bodyParser.json(), templateRegistry.getAllTemplates);
	app.get('/portal/blocks/getAll', securityService.hasPermFilter('System User').check, bodyParser.json(), templateRegistry.getAllBlocks);
