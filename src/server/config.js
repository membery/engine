...
var config = {
	...
	paths : {
		...
		portalTemplates: process.env.REGISTRIES_PATH_TEMPLATES || process.cwd() + '/data/portal/client/templates',
		portalBlocks: process.env.REGISTRIES_PATH_BLOCKS || process.cwd() + '/data/portal/client/blocks',
